...
<div style="width: 1000px; margin: 50px auto 50px;">
	<p style="font-size: 18px; color: #000; margin-bottom: 10px; "><img src="${pageContext.request.contextPath}/images/egovframework/com/cmm/er_logo.jpg" width="379" height="57" /></p>

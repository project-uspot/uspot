		...
		<div class="card-body pb-3">
			<div class="col-12 col-xxl-8">
    			<div class="mb-6">
      				...
      				<form action="membercardinsertP.do" method="post" id="form">
						<div class="row w-75 mb-3">
							<input type="hidden" id="MemberID" name="MemberID" value="${member.memberID}">
					        <div class="col md-1">
					            <input class="form-check-input" id="isReissueN" type="radio" name="isReissue" value="N" checked="checked">
						...
						<div class="input-group mb-3">
							...
							<input class="form-control" id="barCodeOrigin" name="barCodeOrigin" type="hidden"/>
						</div>
						<div class="input-group mb-3">
							<div class="input-group-text">카드수령자</div>
							<input class="form-control" id="suryungJa" name="suryungJa" type="text" value="[${member.memberID}]${member.name}"/>
						</div>
						<div class="input-group mb-3">
							<div class="input-group-text">수령자 연락처</div>
							<input class="form-control" id="suryungJaPhone" name="suryungJaPhone" type="text" value="${member.cellPhone}"/>
						</div>
						<div class="input-group mb-3">
        ...
        success: function(data) {	
       	 if(data != 0){
       	    ...
       	    $.ajax({
       	        ...
       	        url: "membercardinsertP.do", // 실제 엔드포인트로 교체해야 합니다
       	        data: formData,
       	        contentType: false,
       	        processData: false,

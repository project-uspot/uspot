	        ...
	        <div class="card-body mb-n5 mt-n3 me-3 mx-n3" style="height: 525px;">
				...
				<div class="cal-auto">
					<div class="input-group input-group-sm">
						...
						<input type="hidden" id="isflag" name="isflag" value="${uselocker.isFlag}"/>
					</div>
				</div>
				<div class="row">
	        		<div class="col-md-6">
...
function paycredit() {
	...
	var url = "${pageContext.request.contextPath}/locker/CreditCard.do?payprice=" + $("#payprice").val() +"&MemberID="+$('#memberid').val()+"&tempSaleNo="+$('#DBPLockerID').val();
...
function reReceipt(){
	var PKID = $(previousRow).find('.PKID').text();
	var myWindow = window.open("${pageContext.request.contextPath}/locker/ReReceipt.do?PKID="+PKID, "MsgWindow", "width=330,height=800");
	myWindow.print();
}
</script>
</html>

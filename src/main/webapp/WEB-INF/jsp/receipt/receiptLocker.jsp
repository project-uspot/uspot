...
<c:forEach items="${receiptList }" var="receiptMap" varStatus="status">
	...
	<div><span>수강기간: ${receiptMap.FromDate }~${receiptMap.ToDate }(${receiptMap.RegMonth })</span></div>
	<div><span>강 습 료: <fmt:formatNumber value='${receiptMap.UsePrice}' pattern=" #,###" /></span></div>

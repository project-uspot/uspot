	...
	<div class="mb-9">
		...
		<div class="mb-4">
			<div class="row g-3">
				...
				<div class="col-auto">
					<button class="btn btn-info px-5" onclick="location.href='OrderItemInsert.do'" id="insert" title="신규">신규(F2)</button>
					<button class="btn btn-success" type="button" id="excelButton" onclick="fnExcelReport('myTable','일일입장 메뉴관리')"><span class="far fa-file-excel"></span>&emsp;엑셀로 저장</button>
					<script>
						if('${authyn.ins}' == 'N'){
						...
						document.addEventListener('keydown', function(event) {
							if (event.key === 'F2') { // F2 키를 눌렀을 때
								...
								location.href='OrderItemInsert.do';
							}
						});
					</script>
				</div>

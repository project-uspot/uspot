	...
	<div class="col-xl-9">
		...
		<div class="col-12 gy-6">
			<div class="row g-3 justify-content-end">
				<div class="col-auto">
					<a class="btn btn-phoenix-primary px-5" href="${pageContext.request.contextPath}/SLOrderItem.do" style="float: right; margin: 0 0 0 3px;" title="목록">목록</a><!-- 목록 -->
				</div>
				<div class="col-auto">
					<input type="button" class="btn btn-info px-5" style="float: right; margin: 0 0 0 3px;" value="수정" id="modify" onclick="valueChk();"/>
				</div>
				<div class="col-auto">
					<form action="${pageContext.request.contextPath}/deleteDsItem.do" name="formDelete" method="post">
						<input type="submit" class="btn btn-warning px-5" style="float: right; margin: 0 0 0 3px;" value="삭제" id="delete" onclick="fn_egov_delete_article(this.form); return false;"> <!-- 삭제 -->
						<input type="hidden" name="SiteCode" value="${item.siteCode }">
						<input type="hidden" name="pkid" value="${item.pkid }">
					</form>
				</div>

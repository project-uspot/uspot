	        ...
	        <div class="card-body" style="height: 390px;">
	       		<div class="col-7 mb-2">
					<div class="input-group input-group-sm">
						...
						<input class="form-control" type="text" aria-describedby="basic-addon1" id="plockergroupname" name="plockergroupname" value="${vo.PLockerGroupName}"/>
					</div>
				</div>
				<div class="col-7 mb-2">
					<div class="input-group input-group-sm">
						<span class="input-group-text" id="basic-addon1">&ensp;위&emsp;치&ensp;</span>
						<input class="form-control" type="text" aria-describedby="basic-addon1" id="plockerlocation" name="plockerlocation" value="${vo.PLockerLocation}"/>
					</div>
				</div>
				<div class="col-7 mb-2">
					<div class="input-group input-group-sm">
				...
				$('#plockertype').val('${vo.PLockerType}');
				</script>
				<div class="col-7 mb-2">
					<div class="input-group input-group-sm">
						<span class="input-group-text" id="basic-addon1">&ensp;보증금&ensp;</span>
						<fmt:formatNumber value="${vo.PLockerDeposite}" pattern="#,###" var="deposite"/>
						<input class="form-control text-end" type="text" aria-describedby="basic-addon1" id="plockerdeposite" 
						name="plockerdeposite" oninput="onlyNumber(this)" value="${deposite}"/>
					</div>
				</div>
				<div class="row mb-2">
					<div style="width: 241px;">
						<div class="input-group input-group-sm">
							<fmt:formatNumber value="${vo.PLockerPrice}" pattern="#,###" var="price"/>
							<span class="input-group-text" id="basic-addon1">&ensp;사용료&ensp;</span>
							<input class="form-control text-end" type="text" aria-describedby="basic-addon1" id="plockerprice" 
							name="plockerprice" oninput="onlyNumber(this)" value="${price}"/>
						</div>
					</div>
				...
				<script type="text/javascript">
				$('#plockermonth').val('${vo.PLockerMonth}');
				</script>
				<div class="col-7 mb-2">
					<div class="input-group input-group-sm">

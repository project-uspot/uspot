            ...
            <tbody>
                <c:forEach var="list" items="${list}">
                    <tr class="table-row">
                        ...
                        <td class="group-id">${list.groupID}</td>
                        <td class="group-name">${list.groupName}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
...
function choose() {
	...
	opener.document.getElementById("pgmgrouptext").value = pgmgroupvalue;
	opener.document.getElementById("pgmgroup").value = pgmgroupIdvalue;
	self.close();
}

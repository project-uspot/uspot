            ...
            <tbody>
                <c:forEach var="list" items="${list}">
                    <tr class="table-row">
                        ...
                        <td class="group-id">${list.userPKID}</td>
                        <td class="group-name">${list.sawonName}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
...
function choose() {
	...
	opener.document.getElementById("usertext").value = pgmgroupvalue;
	opener.document.getElementById("user").value = pgmgroupIdvalue;
	self.close();
}

            ...
            <tbody>
                <c:forEach var="list" items="${list}">
                    <tr class="table-row">
                        ...
                        <td class="group-id">${list.subGroupID}</td>
                        <td class="group-name">${list.subGroupName}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
...
function choose() {
	...
	opener.document.getElementById("pgmtext").value = pgmgroupvalue;
	opener.document.getElementById("pgm").value = pgmgroupIdvalue;
	self.close();
}

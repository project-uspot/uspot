...
<body>
	<div class="modal-header bg-primary">
				<h5 class="modal-title text-white" id="updateModalLabel">강습종목 변경</h5>
			...
			<div class="modal-body">
				<div class="container">
					<div class="row">
						<div class="col-xl-12">
							<form method="post" id="upfrm01"  name="upfrm01" action="${pageContext.request.contextPath}/updateItem01.do" class="row g-3 mb-6">
									...
									<div class="col-12 mt-2 ">
										<div class="form-check form-check-inline">
											<input type="radio" class="jsType form-check-input" name="jsType" id="jsType0" maxlength="1" value="0">
											<label class="form-check-label" for="jsType1">정시접수</label>                                        
										</div>                                                                                                    
										<div class="form-check form-check-inline ">                                                               
											<input type="radio" class="jsType form-check-input" name="jsType" id="jsType1" maxlength="1" value="1">
											<label class="form-check-label" for="jsType2">수시접수</label>                                        
										</div>                                                                                                    
										<div class="form-check form-check-inline ">                                                               
											<input type="radio" class="jsType form-check-input" name="jsType" id="jsType2" maxlength="1" value="2">
									...
									<div class="col-md-4 gy-4 ">
										...
										<input class="form-control datetimepicker" id="JungSi1Start" name="JungSi1Start" type="text" placeholder="yyyy-mm-dd hour : minute" data-options='{"enableTime":true,"dateFormat":"Y-m-d H:i","disableMobile":true}' />
									</div>
									<div class="col-md-4 gy-4 ">
									...
									<div class="col-md-4 gy-6">
										<div class="form-floating">
											<input class="form-control" id="SortOrder" name="SortOrder" type="text" placeholder="정렬순서"  readonly />
			...
			<div class="modal-footer">
				<button class="btn btn-primary" type="submit" id="update01" >Okay</button>
				<button class="btn btn-outline-primary" type="button" data-bs-dismiss="modal">Cancel</button>
			</div>
			<script>
				$(document).ready(function() {
					$("#update01").click(function() {
						var datas = $("#upfrm01").serialize();

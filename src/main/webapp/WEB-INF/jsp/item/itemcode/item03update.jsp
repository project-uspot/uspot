...
<body>
	<div class="modal-header bg-primary">
		<h5 class="modal-title text-white" id="insertModalLabel">단계정보 변경</h5>
	...
	<div class="modal-body">
		<div class="container">
			<div class="row">
				<div class="col-xl-12">
					<form method="post" id="frm1"  name="frm1" action="${pageContext.request.contextPath}/updateItem03.do" class="row g-3 mb-6">
